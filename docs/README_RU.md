...
**Контракт:** `9R8rrjXxcfQPmLTCLhmVpjr2uesjjkcgkinE6Lwdpump`

Токен $DULUS —— это топливный слой экосистемы Dulus. Open-source REPL остается бесплатным навсегда —— $DULUS —— это ключ к бизнес-слою.

| Фаза | Утилита |
|---|---|
| **Сейчас** | Сообщественное владение. Вознаграждения заблокированы on-chain |
| **Business v1** | Ранний доступ + скидки для холдеров |
| **Кредиты** | Оплата API-кредитов в $DULUS |
| **Развертывания** | Облачные инстансы с оплатой в $DULUS |
| **Подписки** | Ежемесячная подписка с оплатой в $DULUS |
| **Управление** | Топ-холдеры голосуют за приоритет функций |
